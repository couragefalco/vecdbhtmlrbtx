...
logo_path = "https://drive.google.com/uc?export=download&id=1iPc8a0PAnG8mN8n4vB6D1bF3wgZ_Ccrd"
...
# Accept user input
if prompt := st.chat_input("Ask a question about about RBTX:"):
